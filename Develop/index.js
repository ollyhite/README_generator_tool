...
const startQuestions = [
  ...
  },
  {
    type: "input",
    message:
      "Description - Why did you build this project? (Note: the answer is not Because it was a homework assignment.",
    name: "descriptionWhy",
  },
  {
    type: "input",
  ...
  },
  {
    type: "checkbox",
    message:
      "Info list in README - Choose section(s) you want to put in your README file.",
    choices: [
      "Live_link",
      "Table_of_Contents",
      "Installation",
  ...
  },
  {
    type: "input",
    message:
      "Getting Involved - people can reach you with email about question or suggestions, please enter your Eamil address",
    name: "email",
  },
  {
    type: "input",
    message:
      "Getting Involved - What's name that you want to people called you?",
    name: "emailName",
  },
  // {
  //     type:"checkbox",
...
const contentsQuestion = {
  ...
  Installation: [
    ...
    },
    {
      type: "input",
      message:
        "Installation - What are the steps required to install your project? Provide a step-by-step description of how to get the development environment running. Make a Array [] and put your answer. Ex: ['Step1','Step1']",
      name: "installation",
    },
  ],
  Usage: {
    type: "input",
    message:
      "Usage - Provide instructions and examples for use. Include screenshots as needed. To add a screenshot, create an `assets/images` folder in your repository and upload your screenshot to it.:",
    name: "usage",
  },
  Credits: {
    type: "input",
  ...
  Built_With: {
    type: "input",
    message:
      "Built_With - List your Languegs you used in your project, list them in array.",
    name: "built",
  },
  API_Resources: {
    type: "input",
    message:
      "API_Resources - List your API_Resources that you used in your project, put them in array.",
    name: "api",
  },
  Contributing: {
    type: "input",
    message:
      "Contributing - Larger projects often have sections on contributing to their project, in which contribution instructions are outlined. Sometimes, this is a separate file. If you have specific contribution preferences, explain them so that other developers know how to best contribute to your work.",
    name: "contributing",
  },
  License: [
    {
      ...
      name: "license",
      choices: [
        "MIT License - I want it simple and permissive",
        "Apache License 2.0 - Use the license preferred by the community you're contributing to or depending on. Your project will fit right in.",
  ...
  Badges: {
    type: "input",
    message:
      "Badges - Badges aren't necessary, per se, but they demonstrate street cred. Badges let other developers know that you know what you're doing. Check out the badges hosted by [shields.io](https://shields.io/). You may not understand what they all represent now, but you will in time.",
    name: "badges",
  },
  Features: {
    type: "input",
    message:
      "Features - If your project has a lot of features, list them in array here.",
    name: "features",
  },
  Tests: {
    type: "input",
    message:
      "Tests - Go the extra mile and write tests for your application. Then provide examples on how to run them in array.",
    name: "tests",
  },
};
